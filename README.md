...
- A private vector database (Qdrant)
...
User → NGINX → FastAPI → Qdrant → Ollama → Response
...
In this lab, Qdrant is internal-only. It is never exposed directly to the host machine.

---

## text2vec-transformers — Embedding Service

Qdrant does not generate embeddings by itself in this lab.
...
It does not talk to Qdrant directly.
...
[Lesson Overview](https://github.com/JacksonHolmes01/Training-Module-Production-Grade-RAG-Infrastructure-Qdrant/blob/main/lessons/00-lesson-index.md)
...
If you already understand Qdrant, RAG architecture, and containerized systems, go directly to:
...
[Part 2 and Lab Extension](https://github.com/JacksonHolmes01/Training-Module-Production-Grade-RAG-Infrastructure-Qdrant/blob/main/README-INTEGRATION.md)
